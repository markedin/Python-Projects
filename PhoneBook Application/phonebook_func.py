...
# catch if user clicks on the  upper-right x 
def ask_quit(self):
...
def onSelect(self,event):
    ...
    with conn:
        ...
        #returns a tuple and slice into 4 parts using data[] during iteration
        for data in varBody:
...
def addToList(self):
    ...
    #normalize data to keep same as database
    #remove whitespace before/after user entry
    var_fname = var_fname.strip()
    #make each first word capitilized
